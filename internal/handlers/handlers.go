...
import (
	...
	"github.com/thakay/Reservator/internal/forms"
...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	render.RenderTemplate(w, r, "make-reservation.page.gohtml", &models.TemplateData{Form: forms.New(nil)})
}

// PostReservation renders the post to make reservation
